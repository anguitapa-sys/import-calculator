...
# ============================================================
# FUNCIONES DE CÁLCULO DE MATRICULACIÓN
# ============================================================

def limpiar_valor_boe(valor):
...
# ============================================================
# ← FUNCIÓN AÑADIDA: IMPUESTO DE MATRICULACIÓN (Ley 38/1992)
# ============================================================

def calcular_impuesto_matriculacion(base_matriculacion: float, emisiones_co2: float) -> float:
    """
    Calcula el Impuesto de Matriculación según la Ley 38/1992.

    Tramos de CO₂ vigentes:
      ≤ 120 g/km  →  0%
      121-160     →  4.75%
      161-200     →  9.75%
      > 200       →  14.75%

    Recibe la base imponible ya calculada (max entre valor venal depreciado
    y precio sin IVA) y devuelve el importe final redondeado a 2 decimales.
    """
    ...
    return round(base_matriculacion * (porcentaje / 100), 2)
...
async def calcular(datos: SolicitudCalculo):
    ...
    valor_base = limpiar_valor_boe(valor)
